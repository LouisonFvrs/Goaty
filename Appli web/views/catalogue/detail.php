                ...
                <?php if (\utils\SessionHelpers::isLogin()) { ?>
                    <div class="d-flex justify-content-center flex-nowrap mb-5">
                        <div class="w-100" style="background: #F8F9FB">
                            <form action="/catalogue/detail/<?= $ressource->idressource ?>" method="post" class="d-flex justify-content-center align-items-center flex-column">
                                <textarea class="form-control w-75 m-5" name="com" id="com" cols="30" rows="10" placeholder="Rédiger un commentaire..."></textarea>
                                <select class="form-select w-75 " aria-label="Default select example" id="note" name="note">
                                ...
                                <button type="submit" id="modify" class="btn bg-blue-600 text-white hover:bg-blue-900 py-1 px-3 m-4">Commenter</button>
                            </form>
                        </div>
                    </div>
                <?php } ?>
                ...
                if ($commentaires) {
                    foreach ($commentaires as $commentaire) { ?>
                            <div class="profil ml-10 ">
                                <img src="<?= \utils\Gravatar::get_gravatar($commentaire->emailemprunteur) ?>" alt="Photo de profil" class="rounded-full h-10 w-10">
                                ...
                                <?php for($i = 0; $i < $commentaire->noteCom; $i++) { ?>
                                    <svg class="yellowStar" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><style>.yellowStar{fill:#ffea00}</style><path d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"/></svg>
                                <?php    }
                                for($j = 0; $j < 5 - $commentaire->noteCom ; $j++) { ?>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><style>svg{fill: darkgrey}</style><path d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"/></svg>
                                <?php    } ?>
                            </div>
                        <p class="text-gray-500 mb-3 ml-20 font-italic"><?= $commentaire->dateCom ?></p>
                        <p class="text-gray-600 mb-5 ml-20 mr-40 text-justify"><span class="italy">"<?= $commentaire->textCom ?>"</span></p>
                    <?php }} else { ?>
